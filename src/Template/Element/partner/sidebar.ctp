...
<div class="sidebar">
    <ul>
        <!-- <li>
           <a href="#" data-ul="one"><i class="fa fa-user"></i> One <span class="pull-right plusminus">+</span></a>
               <ul class="dropmenu" id="one">
                   <li><a href="#">zone</a></li>
                   <li><a href="#">ztwo</a></li>
               </ul>
           </li> -->
        <li>
            <a href="<?php echo BASE_URL ?>partners/users/dashboard" data-ul="three"><i class="fa fa-tachometer"></i>
                Dashboard</a>
        </li>
        <li>
        ...
        <li class="hide">
            <a href="#" data-ul="three"><i class="fa fa-paper-plane" aria-hidden="true"></i>
                Job Request</a>
        </li>
        <li>
        ...
        <li class="hide">
            <a href="#" data-ul="three"><i class="fa fa-print" aria-hidden="true"></i>
                Invoice</a>
        </li>
    </ul>
</div>
