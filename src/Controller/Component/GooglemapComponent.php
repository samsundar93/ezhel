...
class GooglemapComponent extends Component
{
    ...
    public function getLatitudeLongitude($address) {
        ...
        //$geocode=file_get_contents('https://maps.google.com/maps/api/geocode/json?key=AIzaSyCbF87_gxLI8KUpk3MVmHC9pDlqoYWyuNQ&address='.$prepAddr.'&sensor=false');
